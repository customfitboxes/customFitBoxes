    ...
    <Container maxWidth={"xl"}>
      <div className="pb-14 pt-5">
        ...
        <p className="mt-2 text-center text-base leading-5 opacity-70">
          At Custom Fit Boxes, we specialize in crafting innovative, high-quality custom packaging solutions that enhance brand identity.<br className="hidden xl:block" />Our focus on sustainability, precision, and creativity ensures your packaging leaves a lasting impact in the competitive market.
        </p>
        <div
