    ...
    >
      <Container maxWidth={"xl"}>
        ...
        <div
          className={` hidden ${
            fullNav
              ? "items-start lg:items-center  mt-3 lg:mt-2"
              : "items-center"
          ...
          <ul className="flex items-center gap-x-6 lg:gap-x-10">
            {linksData.map((d: any, ind: any) => (
              ...
              >
                <div className="flex items-center gap-3">
                  ...
                  <Link
                    href={d.path}
                    className={`hover:border-none text-white cursor-pointer text-xs xl:text-base whitespace-nowrap flex items-center gap-x-2 pb-0 mb-0 ${
                      d.name !== "Industries" &&
                      d.name !== "Box by Material" &&
            ...
            {!fullNav && (
              <li className="md:block hidden">
                <button
                  onClick={() => {
                    setOpenStickySearch(!openStickySearch);
                  }}
                >
                  <SerchIcon />
                </button>
