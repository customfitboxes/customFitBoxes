...
const IndustriesDropdown = (props: any) => {
  ...
  return (
    <div
      ...
      className="absolute w-full top-full -mt-4 pt-4 left-0 right-0"
    >
      <div

        className=" bg-white text-black z-30 rounded-lg shadow-lg px-3 sm:px-10 pb-10 pt-5"
      >
            ...
            list.map((category: any, index: any) => (
              <div key={index + 1}>
                <Link
                  ...
                  className="flex items-center gap-x-3 hover:!border-none cursor-pointer hover:font-bold hover:text-black text-gray-700 h-12 sm:h-14 md:h-16"
                >
                  <div>
                    <img
