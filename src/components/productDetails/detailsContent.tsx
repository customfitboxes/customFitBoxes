  ...
  return (
    <Container maxWidth="xl">
      <div className="pt-16 lg:pt-6 pb-10 lg:pb-16">
        <h3 className="fw_600 text-center leading-tight text-3xl primaryText lg:text-4xl">
          Product features
        </h3>
        ...
        <div className="grid grid-cols-12 lg:gap-x-3 xl:gap-x-16 mt-6 lg:mt-14">
          <div className="col-span-12 md:col-span-4 rounded-2xl pt-6 px-6 pb-10">
            <Image width={50} src={msgIcon} alt={"msgIcon"} />
            <p className="primaryText2 fw_600 text-2xl mt-4">Instant quote</p>
          ...
          <div className="col-span-12 md:col-span-4 rounded-2xl primaryBg pt-6 px-6 pb-10">
            <Image width={50} src={touchIcon} alt={"touchIcon"} />
            <p className="text-white fw_600 text-2xl mt-4">An original touch</p>
          ...
          <div className="col-span-12 md:col-span-4 rounded-2xl pt-6 px-6 pb-10">
            <Image width={50} src={lifeCycle} alt={"lifeCycle"} />
            <p className="primaryText2 fw_600 text-2xl mt-4">
              Encological option
            </p>
            <p className="text-sm mt-3">
